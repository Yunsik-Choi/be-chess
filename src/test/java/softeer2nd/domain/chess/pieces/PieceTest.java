...
import static softeer2nd.domain.chess.pieces.Piece.BLACK_REPRESENTATION;
import static softeer2nd.domain.chess.pieces.Piece.WHITE_COLOR;
import static softeer2nd.domain.chess.pieces.Piece.WHITE_REPRESENTATION;
...
public class PieceTest {
    ...
    @Test
    public void create() {
        verifyPieceBy(white, WHITE_COLOR, WHITE_REPRESENTATION, 0, 0);
        verifyPieceBy(black, BLACK_COLOR, BLACK_REPRESENTATION, 0, 1);
    }
    ...
    public void create_기본생성자() {
        ...
        verifyPieceBy(piece, WHITE_COLOR, WHITE_REPRESENTATION, 0, 0);
    }
