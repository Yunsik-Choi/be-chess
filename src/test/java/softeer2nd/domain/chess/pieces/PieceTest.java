...
public class PieceTest {
    ...
    @Test
    public void create() {
        verifyPieceBy(white, Color.WHITE, WHITE_REPRESENTATION.getValue());
        verifyPieceBy(black, Color.BLACK, BLACK_REPRESENTATION.getValue());
    }
    ...
    class createFactoryMethod {
        ...
        void createWhitePawn() throws Exception {
            assertThat(Piece.createWhitePawn()).isEqualTo(createPieceBy(Color.WHITE, WHITE_REPRESENTATION));
        }

        @DisplayName("검은색 폰을 생성한다.")
        @Test
        void createBlackPawn() throws Exception {
            assertThat(Piece.createBlackPawn()).isEqualTo(createPieceBy(Color.BLACK, BLACK_REPRESENTATION));
        }
        ...
        void createWhiteKnight() throws Exception {
            assertThat(Piece.createWhiteKnight())
                    .isEqualTo(createPieceBy(Color.WHITE, WHITE_KNIGHT_REPRESENTATION));
        }
        ...
        void createBlackKnight() throws Exception {
            assertThat(Piece.createBlackKnight())
                    .isEqualTo(createPieceBy(Color.BLACK, BLACK_KNIGHT_REPRESENTATION));
        }
        ...
        void createWhiteRook() throws Exception {
            assertThat(Piece.createWhiteRook())
                    .isEqualTo(createPieceBy(Color.WHITE, PieceRepresentation.WHITE_ROOK_REPRESENTATION));
        }
        ...
        void createBlackRook() throws Exception {
            assertThat(Piece.createBlackRook())
                    .isEqualTo(createPieceBy(Color.BLACK, PieceRepresentation.BLACK_ROOK_REPRESENTATION));
        }
        ...
        void createWhiteBishop() throws Exception {
            assertThat(Piece.createWhiteBishop())
                    .isEqualTo(createPieceBy(Color.WHITE, PieceRepresentation.WHITE_BISHOP_REPRESENTATION));
        }
        ...
        void createBlackBishop() throws Exception {
            assertThat(Piece.createBlackBishop())
                    .isEqualTo(createPieceBy(Color.BLACK, PieceRepresentation.BLACK_BISHOP_REPRESENTATION));
        }
        ...
        void createWhiteQueen() throws Exception {
            assertThat(Piece.createWhiteQueen())
                    .isEqualTo(createPieceBy(Color.WHITE, PieceRepresentation.WHITE_QUEEN_REPRESENTATION));
        }
        ...
        void createBlackQueen() throws Exception {
            assertThat(Piece.createBlackQueen())
                    .isEqualTo(createPieceBy(Color.BLACK, PieceRepresentation.BLACK_QUEEN_REPRESENTATION));
        }
        ...
        void createWhiteKing() throws Exception {
            assertThat(Piece.createWhiteKing())
                    .isEqualTo(createPieceBy(Color.WHITE, PieceRepresentation.WHITE_KING_REPRESENTATION));
        }
        ...
        void createBlackKing() throws Exception {
            assertThat(Piece.createBlackKing())
                    .isEqualTo(createPieceBy(Color.BLACK, PieceRepresentation.BLACK_KING_REPRESENTATION));
        }
    }
